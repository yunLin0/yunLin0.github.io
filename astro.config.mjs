      ...
      head: [
        ...
        // 全页面背景图 + 阅读进度条 + 透明度滑块（用 JS 注入，绕过 CSS 层级）
        {
          ...
          content: [
            ...
            '    .page,.main-frame,.sidebar-pane,.content-panel,.right-sidebar,.header,main{background:transparent!important}',
            '    .sidebar-pane{background:rgba(255,255,255,0.75)!important;backdrop-filter:blur(16px);-webkit-backdrop-filter:blur(16px)}',
            '    .content-panel{background:rgba(255,255,255,0.7)!important;backdrop-filter:blur(12px);-webkit-backdrop-filter:blur(12px);padding-top:2rem!important}',
            '    .right-sidebar{background:rgba(255,255,255,0.75)!important;backdrop-filter:blur(16px);-webkit-backdrop-filter:blur(16px);border-left:1px solid var(--sl-color-gray-6)!important}',
            '    .header{background:rgba(255,255,255,0.7)!important;backdrop-filter:blur(16px);-webkit-backdrop-filter:blur(16px)}',
            '    [data-theme=\\"dark\\"] .sidebar-pane,[data-theme=\\"dark\\"] .right-sidebar{background:rgba(15,23,42,0.75)!important}',
            '    [data-theme=\\"dark\\"] .content-panel,[data-theme=\\"dark\\"] .header{background:rgba(15,23,42,0.7)!important}',
            '  ";',
